                   ...
                   if (+participant.weight !== +opponent.weight) {
                       if (participant.participated_before === opponent.participated_before
                           ...
                           if (!(participant.weight <= 55.9 && (opponent.weight >= participant.weight-0.5 && opponent.weight <= participant.weight+0.5))
                               && !(participant.weight <= 64.3 && participant.weight > 55.9 && opponent.weight >= 60.4 && (opponent.weight >= participant.weight-1 && opponent.weight <= participant.weight+1))
                               && !(participant.weight <= 65.8 && participant.weight > 64.3 && opponent.weight >= 56.9 && (opponent.weight >= participant.weight-1.5 && opponent.weight <= participant.weight+1.5))
                               && !(participant.weight > 65.8 && opponent.weight >= 65.8 && (opponent.weight >= participant.weight-2 && opponent.weight <= participant.weight+2))) {
                               return false;
                           }
                       } else {
                           return false;
